...
nerdqaxe_free_heap_bytes{memory="internal"} 95068
nerdqaxe_free_heap_bytes{memory="spiram"} 6.972844e+06
# HELP nerdqaxe_hashrate_hashes_per_second Current hashrate (hashRate).
# TYPE nerdqaxe_hashrate_hashes_per_second gauge
nerdqaxe_hashrate_hashes_per_second 4.881947e+12
# HELP nerdqaxe_info Device identity, always 1 (deviceModel, ASICModel, asicCount, hostname, hostip, macAddr, version, ssid).
...
nerdqaxe_pool_shares_rejected_total{pool="0"} 231
...
nerdqaxe_stratum_pool_mode{mode="dual"} 0
nerdqaxe_stratum_pool_mode{mode="failover"} 1
